...
class AnswersController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['EvaluationsUsers', 'Questions', 'Alternatives', 'Users']
        ];
    ...
    public function add()
    {
        ...
        $evaluationsUsers = $this->Answers->EvaluationsUsers->find('list', ['limit' => 200]);
        $questions = $this->Answers->Questions->find('list', ['limit' => 200]);
        $alternatives = $this->Answers->Alternatives->find('list', ['limit' => 200]);
        $users = $this->Answers->Users->find('list', ['limit' => 200]);
        $this->set(compact('answer', 'evaluationsUsers', 'questions', 'alternatives', 'users'));
        $this->set('_serialize', ['answer']);
    }
