...
class EvaluationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_avaliacoes_questionarios1_idx' => ['type' => 'index', 'columns' => ['questionnaire_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_avaliacoes_questionarios1' => ['type' => 'foreign', 'columns' => ['questionnaire_id'], 'references' => ['questionnaires', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
